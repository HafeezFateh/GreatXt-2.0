...
function Home(){
    ...
    return(
        ...
        <div id="hero" className="mx-5 mt-10  flex flex-col items-center max-w-7xl md:mx-auto md:mt-25">
                <motion.h1 initial={{ y: 50, opacity: 0 }}
                    animate={{ translateY: -60, opacity: 1 }}
                    transition={{ duration: 0.3 }} className="p-2 bricolage-grotesque text-4xl  md:text-8xl bg-clip-text bg-gradient-to-br from-stone-100 to-stone-600 text-transparent ">GreatXt Agency</motion.h1>
                <motion.p  initial={{ y: 50, opacity: 0 }}
                    animate={{ translateY: -70, opacity: 1 }}
                    transition={{ duration: 0.3, delay: 0.2  }} className="text-xl md:mt-5 poppins-regular  md:text-4xl text-stone-300 text-center">Your <span className="text-lime-600">Brand's success</span>, <br /> is what we want.</motion.p>
           </div>
           ...
           <motion.div initial={{ y: 50, opacity: 0 }}
            ...
            <div className="flex flex-col max-w-7xl mx-auto relative ">
              <div className="bg-lime-400/5 h-[250px]  w-[350px] md:h-[300px] md:w-[1000px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full  absolute inset-0 blur-3xl ">
            ...
            <div className="mt-10 max-w-7xl mx-5 md:mx-auto">
            ...
            <div className=" grid grid-cols-2 md:grid-cols-4 gap-5 ">
                ...
                <h1 className="absolute text-xl text-stone-200 bg-red-500/30 backdrop-blur-md shadow-xl shadow-red-500/10 rounded-3xl px-3 py-1 ">Coming soon</h1>
                </div>
                ...
                <div className=" mx-auto max-w-7xl ">
                    <div className="md:mx-20">                
                        <div className="mx-5 md:mx-auto" >
                            <h1 className="text-3xl text-stone-300 font-semibold md:text-center">About us</h1>
            ...
            <div className="bg-stone-50  ">
                <div className="max-w-7xl mx-5 md:mx-auto pt-5  ">
                    <h1 className="text-4xl font-semibold text-stone-700 poppins-bold  text-center my-10">Designs always transforms </h1>
                    <div className="md:mx-20 grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className=" shadow-2xl/30 shadow-stone-900 bg-gradient-to-br from-red-200 via-red-50 rounded-2xl p-3 ">
                            <h1 className="text-3xl text-stone-100 font-semibold shadow-md/10 rounded-xl bg-red-500 p-3 text-center">Old School Designs </h1>
                        ...
                        <div className=" shadow-2xl/30 shadow-stone-900 bg-gradient-to-br from-green-100 via-green-50 rounded-2xl p-3 ">
                            <h1 className="text-3xl text-stone-100 font-semibold shadow-md/10 rounded-xl bg-lime-600 p-3 text-center">Modern Age Designs</h1>
                            <ul className="p-3 flex flex-col gap-5 my-3">
                                <li className="text-2xl font-semibold text-stone-800 flex gap-3 items-center ">
           ...
           <div className="p-10 h-[200px] w-full flex justify-center items-center relative ">
            ...
            <h1 className="text-3xl bg-gradient-to-br from-white font-bold to-stone-600 text-transparent bg-clip-text  bricolage-grotesque md:text-6xl">Lets get things done </h1>
           </div>
